  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["register-register-module"], {
    ...
    function srcAppRegisterRegisterPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var RegisterPage = /*#__PURE__*/function () {
        function RegisterPage(navCtrl, loadingController, db, afAuth, formBuilder, alertController, http) {
          ...
          this.http.get("http://127.0.0.1:3000/details/9").subscribe(function (data) {
            alert(data.id);
            console.log(data);
          });
        }
        ...
        _createClass(RegisterPage, [{
          ...
          value: function ngOnInit() {
            this.validations_form = this.formBuilder.group({
              name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(2), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])),
              ...
              city: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])),
              state: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])),
              country: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]))
            });
          }
        }, {
          key: "tryRegister",
                    ...
                    case 0:
                      ...
                      return this.loadingController.create({
                        ...
                        a.present().then(function () {
                          _this.registerUser(value).then(function (res) {
                            a.dismiss();
                            _this.errorMessage = ""; //this.successMessage = "Your account has been created. Please log in.";
